...
async function seedSiteConfig() {
  ...
  await client.createOrReplace({
    ...
    navLinks: [
      ...
      { _key: "2", href: "/agrupament", label: "L'AGRUPAMENT", children: [] },
      { _key: "3", href: "/unitats", label: "UNITATS", children: [] },
      { _key: "4", href: "/esdeveniments", label: "NOTÍCIES", children: [] },
      { _key: "5", href: "/galeria", label: "GALERIA", children: [] },
      { _key: "6", href: "/contacte", label: "CONTACTE", children: [] },
    ],
