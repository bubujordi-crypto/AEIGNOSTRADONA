...
export default function UnitatsInfoPage() {
  return (
    <div className="min-h-screen py-12 px-4 mx-auto max-w-4xl">
      ...
      <h1 className="text-4xl font-bold text-scout-green">Info</h1>
      <div className="mt-8 prose prose-lg text-gray-700 max-w-none">
        <p className="text-gray-600">Aquí anirà informació general de les unitats.</p>
      </div>
    </div>
  );
}
