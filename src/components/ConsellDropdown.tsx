...
import { ChevronDown, Network, Users, Briefcase } from "lucide-react";
...
export default function ConsellDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        Explorar seccions
        <ChevronDown size={24} className={`ml-2 transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`} />
      </button>
      {isOpen && (
        <>
